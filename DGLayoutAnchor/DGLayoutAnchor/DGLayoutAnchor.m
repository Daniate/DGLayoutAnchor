...
#pragma - mark private
- (NSLayoutConstraint *)_anchor:(DGLayoutAnchor *)anchor relatedBy:(NSLayoutRelation)relation multiplier:(CGFloat)m constant:(CGFloat)c {
    id v1 = objc_getAssociatedObject(self, dg_layout_anchor_item);
    id v2 = objc_getAssociatedObject(anchor, dg_layout_anchor_item);
...
- (NSLayoutConstraint *)equalTo:(DGLayoutAnchor *)anchor constant:(CGFloat)c {
    return [self _anchor:anchor relatedBy:NSLayoutRelationEqual multiplier:1 constant:c];
}

- (NSLayoutConstraint *)greaterThanOrEqualTo:(DGLayoutAnchor *)anchor constant:(CGFloat)c {
    return [self _anchor:anchor relatedBy:NSLayoutRelationGreaterThanOrEqual multiplier:1 constant:c];
}

- (NSLayoutConstraint *)lessThanOrEqualTo:(DGLayoutAnchor *)anchor constant:(CGFloat)c {
    return [self _anchor:anchor relatedBy:NSLayoutRelationLessThanOrEqual multiplier:1 constant:c];
}
